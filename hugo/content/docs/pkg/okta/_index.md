...
- [type ApplicationsClient](<#ApplicationsClient>)
  ...
  - [func \(c \*ApplicationsClient\) GetApplication\(appID string\) \(\*Application, error\)](<#ApplicationsClient.GetApplication>)
...
- [type Client](<#Client>)
  ...
  - [func \(c \*Client\) Attributes\(\) \*AttributesClient](<#Client.Attributes>)
...
- [type UsersClient](<#UsersClient>)
  ...
  - [func \(c \*UsersClient\) GetDirectUserGroups\(userID string\) \(\*Groups, error\)](<#UsersClient.GetDirectUserGroups>)
  ...
  - [func \(c \*UsersClient\) SuspendUser\(userID string\) error](<#UsersClient.SuspendUser>)
  - [func \(c \*UsersClient\) UnsuspendUser\(userID string\) error](<#UsersClient.UnsuspendUser>)
...
<a name="ApplicationsClient.GetApplication"></a>
...
<a name="UsersClient.GetDirectUserGroups"></a>
### func \(\*UsersClient\) GetDirectUserGroups
...
\- \# Revoke User Sessions \- /api/v1/users/\{userId\}/sessions \- https://developer.okta.com/docs/api/openapi/okta-management/management/tag/UserSessions/#tag/UserSessions/operation/revokeUserSessions

<a name="UsersClient.SuspendUser"></a>
...
<a name="UsersClient.UnsuspendUser"></a>
