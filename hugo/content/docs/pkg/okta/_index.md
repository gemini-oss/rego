...
- [type Client](<#Client>)
  ...
  - [func \(c \*Client\) ConvertApplicationAssignment\(appID string, userID string\) \(\*User, error\)](<#Client.ConvertApplicationAssignment>)
  - [func \(c \*Client\) GenerateRoleReport\(\) \(\*RoleReports, error\)](<#Client.GenerateRoleReport>)
  - [func \(c \*Client\) GetApplicationUser\(appID string, userID string\) \(\*User, error\)](<#Client.GetApplicationUser>)
  ...
  - [func \(c \*Client\) ListAllApplicationUsers\(appID string\) \(\*Users, error\)](<#Client.ListAllApplicationUsers>)
...
<a name="Client.ConvertApplicationAssignment"></a>
...
<a name="Client.GetApplicationUser"></a>
...
<a name="Client.ListAllApplicationUsers"></a>
