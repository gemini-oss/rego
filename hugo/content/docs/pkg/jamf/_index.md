...
- [type Client](<#Client>)
  ...
  - [func \(c \*Client\) GetDeviceMDMCommands\(managementID string\) \(\*MDMCommands, error\)](<#Client.GetDeviceMDMCommands>)
  - [func \(c \*Client\) GetJamfVersion\(\) \(string, error\)](<#Client.GetJamfVersion>)
  - [func \(c \*Client\) GetLockStatus\(managementID string\) \(\*MDMCommands, error\)](<#Client.GetLockStatus>)
  - [func \(c \*Client\) GetLockStatusByUUID\(commandUUID string\) \(\*MDMCommands, error\)](<#Client.GetLockStatusByUUID>)
  - [func \(c \*Client\) GetMDMCommandStatus\(commandUUID string\) \(\*MDMCommandResponse, error\)](<#Client.GetMDMCommandStatus>)
  - [func \(c \*Client\) GetPendingMDMCommands\(managementID string\) \(\*MDMCommands, error\)](<#Client.GetPendingMDMCommands>)
  - [func \(c \*Client\) ListMDMCommands\(query \*MDMCommandQuery\) \(\*MDMCommands, error\)](<#Client.ListMDMCommands>)
  - [func \(c \*Client\) LockComputer\(managementID string, passcode string, message string\) \(\[\]MDMCommandResponse, error\)](<#Client.LockComputer>)
  - [func \(c \*Client\) LockDevice\(managementID string, clientType string, passcode string, message string, phoneNumber string\) \(\[\]MDMCommandResponse, error\)](<#Client.LockDevice>)
  - [func \(c \*Client\) LockMobileDevice\(managementID string, message string, phoneNumber string\) \(\[\]MDMCommandResponse, error\)](<#Client.LockMobileDevice>)
  ...
  - [func \(c \*Client\) SendMDMCommand\(request \*MDMCommandRequest\) \(\[\]MDMCommandResponse, error\)](<#Client.SendMDMCommand>)
...
- [type JamfProperty](<#JamfProperty>)
  - [func \(jp \*JamfProperty\) UnmarshalJSON\(data \[\]byte\) error](<#JamfProperty.UnmarshalJSON>)
...
- [type MDMClient](<#MDMClient>)
- [type MDMClientData](<#MDMClientData>)
- [type MDMClientTypes](<#MDMClientTypes>)
- [type MDMCommandData](<#MDMCommandData>)
- [type MDMCommandQuery](<#MDMCommandQuery>)
- [type MDMCommandRequest](<#MDMCommandRequest>)
- [type MDMCommandResponse](<#MDMCommandResponse>)
- [type MDMCommandStatuses](<#MDMCommandStatuses>)
- [type MDMCommandTypes](<#MDMCommandTypes>)
- [type MDMCommands](<#MDMCommands>)
...
<a name="ClientType"></a>ClientType is an instance of MDMClientTypes with the valid values.
...
<a name="CommandStatus"></a>CommandStatus is an instance of MDMCommandStatuses with the valid values.
...
<a name="CommandType"></a>CommandType is an instance of MDMCommandTypes with the valid values.
...
<a name="Client.GetDeviceMDMCommands"></a>
### func \(\*Client\) GetDeviceMDMCommands
...
- GET /api/v2/mdm/commands?filter=managementId==\{managementID\};command==DEVICE\_LOCK
- \- https://developer.jamf.com/jamf-pro/reference/get_v2-mdm-commands
- Retrieves ALL DEVICE\_LOCK commands for a specific device by management ID.

<a name="Client.GetLockStatusByUUID"></a>
### func \(\*Client\) GetLockStatusByUUID
...
- \- https://developer.jamf.com/jamf-pro/reference/get_v2-mdm-commands
- Retrieves the status of a DEVICE\_LOCK command by its UUID.
- The UUID is returned from LockComputer/LockMobileDevice/LockDevice.

<a name="Client.GetMDMCommandStatus"></a>
### func \(\*Client\) GetMDMCommandStatus
...
<a name="Client.GetPendingMDMCommands"></a>
### func \(\*Client\) GetPendingMDMCommands
...
<a name="Client.ListMDMCommands"></a>
### func \(\*Client\) ListMDMCommands
...
<a name="Client.LockComputer"></a>
### func \(\*Client\) LockComputer
...
<a name="Client.LockDevice"></a>
### func \(\*Client\) LockDevice
...
- /api/v2/mdm/commands
- \- https://developer.jamf.com/jamf-pro/reference/post_v2-mdm-commands
- Sends a DEVICE\_LOCK MDM command to lock a device.
...
<a name="Client.LockMobileDevice"></a>
### func \(\*Client\) LockMobileDevice
...
<a name="Client.SendMDMCommand"></a>
### func \(\*Client\) SendMDMCommand
...
<a name="JamfProperty.UnmarshalJSON"></a>
### func \(\*JamfProperty\) UnmarshalJSON
...
<a name="MDMCommandQuery"></a>
## type MDMCommandQuery
...
<a name="MDMCommandRequest"></a>
## type MDMCommandRequest

MDMCommandRequest represents the request body for sending MDM commands via /api/v2/mdm/commands. https://developer.jamf.com/jamf-pro/reference/post_v2-mdm-commands
...
<a name="MDMCommandResponse"></a>
## type MDMCommandResponse

MDMCommandResponse represents the response from sending an MDM command. Also used for individual command status via GET /api/v2/mdm/commands/\{id\}.
...
<a name="MDMCommandStatuses"></a>
## type MDMCommandStatuses
...
<a name="MDMCommandTypes"></a>
## type MDMCommandTypes
...
<a name="MDMCommands"></a>
## type MDMCommands

MDMCommands represents a paginated list of MDM commands from GET /api/v2/mdm/commands. https://developer.jamf.com/jamf-pro/reference/get_v2-mdm-commands
