...
## func [ConvertAttributes](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L58>)
...
<a name="NewClient"></a>
### func [NewClient](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/active_directory.go#L70>)
...
### func \(\*Client\) [BuildDN](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/active_directory.go#L50>)
...
### func \(\*Client\) [GetCache](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/active_directory.go#L198>)
...
### func \(\*Client\) [LockedUsers](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/users.go#L96>)
...
### func \(\*Client\) [MemberOf](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/users.go#L133>)
...
### func \(\*Client\) [PasswordNeverExpiresUsers](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/users.go#L115>)
...
### func \(\*Client\) [SetCache](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/active_directory.go#L185>)
...
<a name="Filter"></a>
## type [Filter](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L52-L56>)
...
<a name="LDAPQuery"></a>
## type [LDAPQuery](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L38-L50>)
...
### func [NewLDAPQuery](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L67>)
...
### func \(\*LDAPQuery\) [IsEmpty](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L173>)
...
### func \(\*LDAPQuery\) [SetAttributes](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L95>)
...
### func \(\*LDAPQuery\) [SetBaseDN](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L83>)
...
### func \(\*LDAPQuery\) [SetDerefAliases](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L107>)
...
### func \(\*LDAPQuery\) [SetFilter](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L89>)
...
### func \(\*LDAPQuery\) [SetPagingSize](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L131>)
...
### func \(\*LDAPQuery\) [SetScope](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L101>)
...
### func \(\*LDAPQuery\) [SetSizeLimit](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L113>)
...
### func \(\*LDAPQuery\) [SetTimeLimit](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L119>)
...
### func \(\*LDAPQuery\) [SetTypesOnly](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L125>)
...
### func \(\*LDAPQuery\) [Validate](<https://github.com/gemini-oss/rego/blob/main/pkg/active_directory/query.go#L137>)
