...
- [type Client](<#Client>)
  ...
  - [func \(c \*Client\) GenerateRoleReport\(roleId string, customer \*Customer\) \(\[\]\*RoleReport, error\)](<#Client.GenerateRoleReport>)
  - [func \(c \*Client\) GetAssignmentsForRole\(roleId string, customer \*Customer\) \(\*RoleAssignment, error\)](<#Client.GetAssignmentsForRole>)
  ...
  - [func \(c \*Client\) GetRole\(roleId string, customer \*Customer\) \(\*Role, error\)](<#Client.GetRole>)
  ...
  - [func \(c \*Client\) ListAllDevicePolicySchemas\(customer \*Customer\) \(\*PolicySchemas, error\)](<#Client.ListAllDevicePolicySchemas>)
  - [func \(c \*Client\) ListAllRoleAssignments\(customer \*Customer\) \(\*RoleAssignment, error\)](<#Client.ListAllRoleAssignments>)
  - [func \(c \*Client\) ListAllRoles\(customer \*Customer\) \(\*Roles, error\)](<#Client.ListAllRoles>)
  ...
  - [func \(c \*Client\) MyCustomer\(\) \(\*Customer, error\)](<#Client.MyCustomer>)
  - [func \(c \*Client\) ResolvePolicySchemas\(OU string, customer \*Customer\) \(\*ResolvedPolicies, error\)](<#Client.ResolvePolicySchemas>)
...
- [type DeviceClient](<#DeviceClient>)
  - [func \(dc \*DeviceClient\) ListAllChromeOS\(customer \*Customer\) \(\*ChromeOSDevices, error\)](<#DeviceClient.ListAllChromeOS>)
  - [func \(dc \*DeviceClient\) ListAllProvisionedChromeOS\(customer \*Customer\) \(\*ChromeOSDevices, error\)](<#DeviceClient.ListAllProvisionedChromeOS>)
  - [func \(dc \*DeviceClient\) MaxResults\(max int\) \*DeviceClient](<#DeviceClient.MaxResults>)
  - [func \(dc \*DeviceClient\) PageToken\(token string\) \*DeviceClient](<#DeviceClient.PageToken>)
  - [func \(dc \*DeviceClient\) Query\(query string\) \*DeviceClient](<#DeviceClient.Query>)
...
### func \(\*Client\) GetPermissionDetails
...
### func \(\*Client\) ListAllDevicePolicySchemas
...
<a name="Client.MyCustomer"></a>
### func \(\*Client\) MyCustomer
...
### func \(\*Client\) ResolvePolicySchemas
...
### func \(\*Client\) SaveFileListToSheet
